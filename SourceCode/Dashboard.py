...
def predictor():
    ...
    for i in range(len(fileEntry)):
        ...
        # goodpoints and matcches sum from 1.png and customgestureimages is grater than 20
...
class Dashboard(QtWidgets.QMainWindow):
    ...
    def quitApplication(self):
        ...
        userReply = QMessageBox.question(
            self, 'Quit Application', "Are you sure you want to quit this app?", QMessageBox.Yes | QMessageBox.No, QMessageBox.No)
    ...
    def createGest(self):
        ...
        # create QImage from image
            qImg2 = QImage(img2.data, width2, height2,
                           step2, QImage.Format_RGB888)
        ...
        if os.path.exists("./SampleGestures/"+str(gesname)+".png"):
            QtWidgets.QMessageBox.about(
                self, "Success", "Gesture Saved Successfully!")
    ...
    def on_click(self):
        ...
        try:
            ...
            QtWidgets.QMessageBox.about(
                self, "Information", "Nothing to export")
        fw.close()
        root.destroy()
        ...
        if not os.path.exists('temp.txt'):
            if os.path.exists('.txt'):
                ...
                QtWidgets.QMessageBox.about(
                    self, "Information", "File saved successfully!")
    ...
    def scanSent(self):
        ...
        if os.path.exists('temp.txt'):
            QtWidgets.QMessageBox.about(
                self, "Information", "File is temporarily saved ... you can now proceed to export")
        try:
            self.textBrowser.setText("		 ")
        except:
            pass
